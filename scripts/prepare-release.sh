...
check_git_dependency "wf-engine" "wf-engine"
check_git_dependency "wf-config" "wf-config"
check_git_dependency "wf-lang" "wf-lang"
...
echo "  6. Verify release at: https://github.com/wp-labs/warp-fusion/releases/tag/$TAG_NAME"
echo
