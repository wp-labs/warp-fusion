...
echo "============================================"
echo "  streaming_ipv6: wpgen(IPv6 nginx logs) → TCP → wparse → Arrow TCP → wfusion"
...
echo "3> wpgen: sending $LINE_CNT IPv6 nginx logs (models/wpl/sample.dat) over TCP :9801..."
