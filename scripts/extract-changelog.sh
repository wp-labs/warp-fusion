...
if [[ -f "CHANGELOG.md" ]]; then
    ...
    if [[ -s /tmp/changelog-zh.md ]]; then
        ...
        echo "请查看完整的 [CHANGELOG.md](https://github.com/wp-labs/warp-fusion/blob/$BRANCH/CHANGELOG.md)" >> /tmp/changelog-zh.md
    fi
else
...
if [[ -f "CHANGELOG.en.md" ]]; then
    ...
    if [[ -s /tmp/changelog-en.md ]]; then
        ...
        echo "Please see the full [CHANGELOG.en.md](https://github.com/wp-labs/warp-fusion/blob/$BRANCH/CHANGELOG.en.md)" >> /tmp/changelog-en.md
    fi
else
