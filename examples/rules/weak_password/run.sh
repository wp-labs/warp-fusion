...
echo "1> lint rule"
"$WFL_BIN" lint rules/weak_password.wfl --schemas "schemas/*.wfs"

echo "2> run inline tests"
TEST_OUT="$("$WFL_BIN" test rules/weak_password.wfl --schemas "schemas/*.wfs")"
echo "$TEST_OUT"
...
echo "OK: weak_password batch replay produced 0 alerts"
